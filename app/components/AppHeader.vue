<template>
  <nav class="bg-white shadow-md z-40 relative">
      ...
      <div class="flex items-center justify-between h-20">
        ...
        <div class="flex items-center">
          <button class="hidden md:flex items-center gap-2 bg-green-700 hover:bg-green-800 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-md transition-colors duration-200 ml-4">
            <Icon name="fluent:person-support-32-filled" class="w-5 h-5" />
    ...
    >
      <div v-if="isMobileMenuOpen" id="mobile-menu" class="md:hidden absolute w-full bg-white shadow-xl border-t border-gray-100">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <button class="w-full mt-2 bg-green-700 hover:bg-green-800 text-white px-4 py-2 rounded-lg text-base font-medium shadow-md transition-colors duration-200">
            <Icon name="mdi:headset" class="w-5 h-5 inline-block mr-1 -mt-0.5" />
            Konsultasi
          </button>
        </div>
      </div>
